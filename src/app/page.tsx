            ...
            <div className="flex items-center space-x-12">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
                  <span>securo</span>
                  <span className="text-transparent bg-gradient-to-r from-teal-500 to-blue-600 bg-clip-text">x</span>
                </div>
              </div>
              
              {/* Enhanced Navigation */}
              <nav className="hidden lg:flex space-x-8">
                <a href="#" className="relative text-teal-600 font-semibold group">
                  Home
                ...
                <a href="#" className="text-gray-700 hover:text-teal-600 font-medium transition-all duration-300 group">
                  About Us
        ...
        <div className="flex-1 p-8 lg:p-16 flex flex-col justify-center relative">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-600 text-xl mb-10 leading-relaxed max-w-lg">
              Reduce risk, ship products faster, and resolve issues proactively, by upgrading your infrastructure with 
              <span className="font-semibold text-teal-600"> securex</span>.
            </p>
            
            {/* Enhanced CTA Button */}
            <div className="flex flex-col sm:flex-row gap-4 mb-16">
              <button className="group relative px-8 py-4 bg-gradient-to-r from-teal-500 to-blue-600 text-white font-semibold rounded-xl text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-teal-500/25 btn-glow glow-animation">
            ...
            <div className="grid grid-cols-3 gap-8 mb-16">
              <div className="text-center hover-lift p-4 rounded-xl">
                <div className="text-3xl font-bold text-teal-600 mb-2 text-gradient-animate">99.9%</div>
                <div className="text-gray-600 text-sm">Uptime</div>
              </div>
              <div className="text-center hover-lift p-4 rounded-xl">
                <div className="text-3xl font-bold text-blue-600 mb-2 text-gradient-animate">24/7</div>
                <div className="text-gray-600 text-sm">Monitoring</div>
              </div>
              <div className="text-center hover-lift p-4 rounded-xl">
                <div className="text-3xl font-bold text-purple-600 mb-2 text-gradient-animate">10K+</div>
        ...
        <div className="flex-1 bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden">
          ...
          <div className="absolute right-8 top-1/2 transform -translate-y-1/2 text-white">
            ...
            <div className="flex flex-col space-y-6">
              ...
              <button className="group w-12 h-12 bg-white/10 backdrop-blur-sm hover:bg-white/20 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-white/20">
                <svg className="w-6 h-6 group-hover:text-pink-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-xl max-w-2xl mx-auto">
              Choose from our wide range of high-quality security cameras designed for every environment
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">HD Dome Camera Pro</h3>
                <p className="text-gray-600 mb-4">1080p HD resolution with night vision and motion detection</p>
                
                {/* Features */}
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-teal-100 text-teal-800 px-2 py-1 rounded-full text-xs font-medium">1080p HD</span>
                  <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-xs font-medium">Night Vision</span>
                  <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-full text-xs font-medium">Motion Detection</span>
                </div>
                
                {/* Price */}
                <div className="flex items-center justify-between mb-4">
                  <div className="text-2xl font-bold text-gray-900">₮450,000</div>
                  <div className="text-sm text-gray-500 line-through">₮550,000</div>
                </div>
            ...
            <div 
              ...
              onClick={() => openProductModal({
                ...
                description: "4K ultra HD with 360° pan and tilt capabilities",
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">4K Bullet Camera Ultra</h3>
                <p className="text-gray-600 mb-4">4K ultra HD with 360° pan and tilt capabilities</p>
                
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-red-100 text-red-800 px-2 py-1 rounded-full text-xs font-medium">4K Ultra HD</span>
                  <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs font-medium">360° View</span>
                  <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs font-medium">Weatherproof</span>
                </div>
                
                <div className="flex items-center justify-between mb-4">
                  <div className="text-2xl font-bold text-gray-900">₮850,000</div>
                  <div className="text-sm text-gray-500 line-through">₮950,000</div>
                </div>
                ...
                <div>
                  <button 
                    onClick={(e) => {
                      ...
                      alert("Таны хүсэлтийг хүлээн авлаа. Бид танд удахгүй холбогдох болно!");
                    }}
            ...
            <div 
              ...
              onClick={() => openProductModal({
                ...
                description: "Professional PTZ with AI-powered tracking and analytics",
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">PTZ Security Camera</h3>
                <p className="text-gray-600 mb-4">Professional PTZ with AI-powered tracking and analytics</p>
                
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-full text-xs font-medium">AI Tracking</span>
                  <span className="bg-indigo-100 text-indigo-800 px-2 py-1 rounded-full text-xs font-medium">PTZ Control</span>
                  <span className="bg-pink-100 text-pink-800 px-2 py-1 rounded-full text-xs font-medium">Analytics</span>
                </div>
                
                                <div className="flex items-center justify-between mb-4">
                  <div className="text-2xl font-bold text-gray-900">₮1,250,000</div>
                  <div className="text-sm text-gray-500 line-through">₮1,450,000</div>
                </div>
            ...
            <div 
              ...
              onClick={() => openProductModal({
                ...
                description: "Wireless HD camera with mobile app control and cloud storage",
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">WiFi Security Camera</h3>
                <p className="text-gray-600 mb-4">Wireless HD camera with mobile app control and cloud storage</p>
                
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-xs font-medium">WiFi</span>
                  <span className="bg-emerald-100 text-emerald-800 px-2 py-1 rounded-full text-xs font-medium">Mobile App</span>
                  <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-xs font-medium">Cloud Storage</span>
                </div>
                
                <div className="flex items-center justify-between mb-4">
                  <div className="text-2xl font-bold text-gray-900">₮320,000</div>
                  <div className="text-sm text-gray-500 line-through">₮380,000</div>
                </div>
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Smart Doorbell Camera</h3>
                <p className="text-gray-600 mb-4">Video doorbell with two-way audio and motion alerts</p>
                
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-orange-100 text-orange-800 px-2 py-1 rounded-full text-xs font-medium">Two-way Audio</span>
                  <span className="bg-red-100 text-red-800 px-2 py-1 rounded-full text-xs font-medium">Motion Alerts</span>
                  <span className="bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full text-xs font-medium">HD Video</span>
                </div>
                
                <div className="flex items-center justify-between mb-4">
                  <div className="text-2xl font-bold text-gray-900">₮280,000</div>
                  <div className="text-sm text-gray-500 line-through">₮350,000</div>
                </div>
            ...
            <div 
              ...
              onClick={() => openProductModal({
                ...
                description: "Advanced thermal imaging for complete darkness detection",
                features: ["Thermal Imaging", "Night Detection", "Heat Sensing"],
                badge: "Thermal",
                badgeColor: "violet"
              })}
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Thermal Security Camera</h3>
                <p className="text-gray-600 mb-4">Advanced thermal imaging for complete darkness detection</p>
                
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="bg-violet-100 text-violet-800 px-2 py-1 rounded-full text-xs font-medium">Thermal Imaging</span>
                  <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-full text-xs font-medium">Night Detection</span>
                  <span className="bg-indigo-100 text-indigo-800 px-2 py-1 rounded-full text-xs font-medium">Heat Sensing</span>
                </div>
                
                <div className="flex items-center justify-between mb-4">
                  <div className="text-2xl font-bold text-gray-900">₮1,800,000</div>
                  <div className="text-sm text-gray-500 line-through">₮2,100,000</div>
                </div>
            ...
            <div className="p-6 overflow-y-auto max-h-96">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="relative h-80 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl flex items-center justify-center shadow-lg">
                  ...
                  <div className={`absolute top-4 left-4 px-4 py-2 rounded-full text-sm font-semibold text-white bg-gradient-to-r ${
                    selectedProduct.badgeColor === 'teal' ? 'from-teal-500 to-blue-600' :
                    selectedProduct.badgeColor === 'red' ? 'from-red-500 to-pink-600' :
                    selectedProduct.badgeColor === 'purple' ? 'from-purple-500 to-indigo-600' :
                    selectedProduct.badgeColor === 'green' ? 'from-green-500 to-emerald-600' :
                    selectedProduct.badgeColor === 'orange' ? 'from-orange-500 to-red-600' :
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedProduct.features.map((feature, index) => (
                        <span key={index} className="px-3 py-2 bg-teal-50 text-teal-800 rounded-full text-sm font-medium border border-teal-200">
                          {feature}
                        </span>
                      ))}
                    </div>
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 mb-3">Technical Specifications</h4>
                  ...
                  <div className="bg-gradient-to-r from-teal-50 to-blue-50 p-6 rounded-2xl border border-teal-100">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        ...
                        <div className="text-lg text-gray-500 line-through">₮{selectedProduct.originalPrice.toLocaleString()}</div>
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                Your trusted partner in security solutions. We provide cutting-edge security cameras and monitoring systems to protect what matters most.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors duration-300">Products</a></li>
                <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors duration-300">Services</a></li>
                <li><a href="#" className="text-gray-300 hover:text-teal-400 transition-colors duration-300">Support</a></li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium">Sukhbaatar District, Ulaanbaatar</p>
                  </div>
                </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 mt-4 md:mt-0">
                ...
                <a href="#" className="text-gray-400 hover:text-teal-400 text-sm transition-colors duration-300">Terms of Service</a>
                <a href="#" className="text-gray-400 hover:text-teal-400 text-sm transition-colors duration-300">Cookie Policy</a>
              </div>
            </div>
          </div>
        </div>
